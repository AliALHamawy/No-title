        ...
        <>
            <div className="blogDetails p-4 lg:p-20 md:p-20">
                <div className="cont max-w-[931.33px] m-auto flex flex-col mt-40">
                    ...
                    <img src="/assets/images/blog/blog-details-02.jpg" alt="" className="max-w-full rounded-sm mb-10" />
                    ...
                    <div className="bg-[#4a6cf71a] text-[16px] p-9 rounded-xl text-(--textcolor-secound) abcd">
