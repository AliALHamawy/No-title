...
function Hero() {
  return (
    <>
      <div className="hero bg-(--bg-secound) h-[751px] pt-[95.97px] relative">
        <img src="/assets/images/hero/shape-01.svg" alt="" className='absolute top-0 right-0' />
        <img src="/assets/images/hero/shape-02.svg" alt="" className='absolute bottom-0 left-0' />
