        ...
        <div className="cont flex justify-center m-auto gap-10 mt-40">
          ...
          <div className="right flex flex-col  gap-10">
            <div className='bg-(--bg-secound) h-[98px] flex p-6 gap-3'>
              <input type="text" name="" id="" placeholder='search' className='px-3 bg-(--input-bg) h-[50px] w-[320px]' />
            ...
            <div className="bg-(--bg-secound)">
              ...
              <div className="flex p-6 gap-4 flex-wrap ">
                  ...
                  <button className='bg-(--heroBtn-bg) transition duration-300 text-(--textcolor-main) hover:bg-(--color-main) p-2 text-[18px]'>Themes</button>
                  <button className='bg-(--heroBtn-bg) transition duration-300 text-(--textcolor-main) hover:bg-(--color-main) p-2 text-[18px]'>UI Kit</button>
                  <button className='bg-(--heroBtn-bg) transition duration-300 text-(--textcolor-main) hover:bg-(--color-main) p-2 text-[18px]'>Tailwind</button>
                  <button className='bg-(--heroBtn-bg) transition duration-300 text-(--textcolor-main) hover:bg-(--color-main) p-2 text-[18px]'>Startup</button>
                  <button className='bg-(--heroBtn-bg) transition duration-300 text-(--textcolor-main) hover:bg-(--color-main) p-2 text-[18px]'>Business</button>
              </div>
            </div>
