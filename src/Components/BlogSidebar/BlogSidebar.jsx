...
function BlogSidebar() {
  const [bost, setBost] = useState(info)
  return (
    <>
      <div className="blogsSidebar p-4 lg:p-10 md:p-10">
        <div className="cont flex justify-center m-auto gap-10 mt-40">
          <div className="left flex-col max-w-[931.33px]">
            <div className="head border-b border-(--border)">
              ...
              <div className="flex justify-between items-center text-center align-middle py-8 flex-wrap gap-5">
                <div className="avatar flex gap-4 items-center">
                  <img src="/assets/images/blog/author-01.png" alt="" />
            ...
            <img src="/assets/images/blog/blog-details-01.jpg" alt="" className="w-full rounded-sm mb-10" />
            ...
            <div className="bg-[#4a6cf71a] text-[16px] p-9 rounded-xl text-(--textcolor-secound) abcd relative">
              ...
              <span className="absolute left-0 top-0 z-[-1]"><svg width="132" height="109" viewBox="0 0 132 109" fill="none" xmlns="http://www.w3.org/2000/svg"><path opacity="0.5" d="M33.0354 90.11C19.9851 102.723 -3.75916 101.834 -14 99.8125V-15H132C131.456 -12.4396 127.759 -2.95278 117.318 14.5117C104.268 36.3422 78.7114 31.8952 63.2141 41.1934C47.7169 50.4916 49.3482 74.3435 33.0354 90.11Z" fill="url(#paint0_linear_111:606)"></path><path opacity="0.5" d="M33.3654 85.0768C24.1476 98.7862 1.19876 106.079 -9.12343 108.011L-38.876 22.9988L100.816 -25.8905C100.959 -23.8126 99.8798 -15.5499 94.4164 0.87754C87.5871 21.4119 61.9822 26.677 49.5641 38.7512C37.146 50.8253 44.8877 67.9401 33.3654 85.0768Z" fill="url(#paint1_linear_111:606)"></path><defs><linearGradient id="paint0_linear_111:606" x1="94.7523" y1="82.0246" x2="8.40951" y2="52.0609" gradientUnits="userSpaceOnUse"><stop stopColor="white" stopOpacity="0.06"></stop><stop offset="1" stopColor="white" stopOpacity="0"></stop></linearGradient><linearGradient id="paint1_linear_111:606" x1="90.3206" y1="58.4236" x2="1.16149" y2="50.8365" gradientUnits="userSpaceOnUse"><stop stopColor="white" stopOpacity="0.06"></stop><stop offset="1" stopColor="white" stopOpacity="0"></stop></linearGradient></defs></svg></span>
              <span className="absolute right-0 bottom-0 rotate-180 z-[-1]"><svg width="132" height="109" viewBox="0 0 132 109" fill="none" xmlns="http://www.w3.org/2000/svg"><path opacity="0.5" d="M33.0354 90.11C19.9851 102.723 -3.75916 101.834 -14 99.8125V-15H132C131.456 -12.4396 127.759 -2.95278 117.318 14.5117C104.268 36.3422 78.7114 31.8952 63.2141 41.1934C47.7169 50.4916 49.3482 74.3435 33.0354 90.11Z" fill="url(#paint0_linear_111:606)"></path><path opacity="0.5" d="M33.3654 85.0768C24.1476 98.7862 1.19876 106.079 -9.12343 108.011L-38.876 22.9988L100.816 -25.8905C100.959 -23.8126 99.8798 -15.5499 94.4164 0.87754C87.5871 21.4119 61.9822 26.677 49.5641 38.7512C37.146 50.8253 44.8877 67.9401 33.3654 85.0768Z" fill="url(#paint1_linear_111:606)"></path><defs><linearGradient id="paint0_linear_111:606" x1="94.7523" y1="82.0246" x2="8.40951" y2="52.0609" gradientUnits="userSpaceOnUse"><stop stopColor="white" stopOpacity="0.06"></stop><stop offset="1" stopColor="white" stopOpacity="0"></stop></linearGradient><linearGradient id="paint1_linear_111:606" x1="90.3206" y1="58.4236" x2="1.16149" y2="50.8365" gradientUnits="userSpaceOnUse"><stop stopColor="white" stopOpacity="0.06"></stop><stop offset="1" stopColor="white" stopOpacity="0"></stop></linearGradient></defs></svg></span>
            ...
            <div className="flex justify-between flex-wrap gap-5">
              <div className="left flex flex-col">
                ...
                <div className="flex gap-5">
                  <button className='bg-(--blogs-icons) transition duration-300 text-(--textcolor-main) hover:bg-(--color-main) p-2 text-[12px] m-auto'>Design</button>
                  <button className='bg-(--blogs-icons) transition duration-300 text-(--textcolor-main) hover:bg-(--color-main) p-2 text-[12px] m-auto'>Development</button>
                  <button className='bg-(--blogs-icons) transition duration-300 text-(--textcolor-main) hover:bg-(--color-main) p-2 text-[12px] m-auto'>Info</button>
                </div>
              </div>
              <div className="flex flex-col">
                <h1 className="text-[16px] text-(--textcolor-secound)">Share this post :</h1>
                <div className="flex gap-5">
                  <button className='bg-(--blogs-icons) transition duration-300 text-(--textcolor-main) hover:bg-(--color-main) p-2 text-[18px] m-auto'><AiFillLinkedin /></button>
                  <button className='bg-(--blogs-icons) transition duration-300 text-(--textcolor-main) hover:bg-(--color-main) p-2 text-[18px] m-auto'><AiFillInstagram /></button>
                  <button className='bg-(--blogs-icons) transition duration-300 text-(--textcolor-main) hover:bg-(--color-main) p-2 text-[18px] m-auto'><AiFillGithub /></button>
                </div>
              </div>
            </div>
          </div>
          <div className="right flex flex-col  gap-10">
            <div className='bg-(--bg-secound) h-[98px] flex p-6 gap-3'>
              <input type="text" name="" id="" placeholder='search' className='px-3 bg-(--input-bg) h-[50px] w-[320px] outline-0 border border-(--input-bg) text-(--textcolor-secound) focus:border-(--color-main)' />
              <div className="bg-(--color-main) h-[50px] w-[50px] flex text-center align-middle items-center justify-center"><BiSearchAlt className="text-3xl text-(--textcolor-main)" /></div>
            </div>
            <div className="bg-(--bg-secound)">
              <div className="border-b p-6 text-(--textcolor-main) border-(--border)"><h1 className="text-xl font-black">Related Posts</h1></div>
              <div className="flex flex-col p-6 gap-2">
                {bost.map((item) => (
                  <div className={`flex ${item.border ? "border-b" : ''} border-(--border) gap-1 items-center`} key={item.id}>
                    <img src={item.imagePath} alt="" className="h-[75px] w-[85px] rounded-xl" />
                    <div className="flex flex-col p-2">
                      <h1 className="text-[16px] text-(--textcolor-main)">{item.title}</h1>
                      <p className="text-[14px] text-(--textcolor-secound)">{item.date}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-(--bg-secound)">
              <div className="border-b p-6 text-(--textcolor-main) border-(--border)"><h1 className="text-xl font-black">Popular Category</h1></div>
              <div className="flex flex-col p-6 gap-4">
                <p className="text-[16px] text-(--textcolor-secound) transition-all duration-300 hover:text-(--color-main)">Tailwind Templates</p>
                <p className="text-[16px] text-(--textcolor-secound) transition-all duration-300 hover:text-(--color-main)">Landing page</p>
                <p className="text-[16px] text-(--textcolor-secound) transition-all duration-300 hover:text-(--color-main)">Startup</p>
                <p className="text-[16px] text-(--textcolor-secound) transition-all duration-300 hover:text-(--color-main)">Business</p>
                <p className="text-[16px] text-(--textcolor-secound) transition-all duration-300 hover:text-(--color-main)">Multipurpose</p>
              </div>
            </div>
            <div className="bg-(--bg-secound)">
              <div className="border-b p-6 text-(--textcolor-main) border-(--border)"><h1 className="text-xl font-black">Popular Tags</h1></div>
              <div className="flex p-6 gap-4 flex-wrap ">
                
                  <button className='bg-(--blogs-icons) transition duration-300 text-(--textcolor-main) hover:bg-(--color-main) p-2 text-[18px]'>Themes</button>
                  <button className='bg-(--blogs-icons) transition duration-300 text-(--textcolor-main) hover:bg-(--color-main) p-2 text-[18px]'>UI Kit</button>
                  <button className='bg-(--blogs-icons) transition duration-300 text-(--textcolor-main) hover:bg-(--color-main) p-2 text-[18px]'>Tailwind</button>
                  <button className='bg-(--blogs-icons) transition duration-300 text-(--textcolor-main) hover:bg-(--color-main) p-2 text-[18px]'>Startup</button>
                  <button className='bg-(--blogs-icons) transition duration-300 text-(--textcolor-main) hover:bg-(--color-main) p-2 text-[18px]'>Business</button>
              </div>
            </div>
            <div className="right min-h-[617px] bg-(--bg-secound) p-10 flex flex-col gap-4">
