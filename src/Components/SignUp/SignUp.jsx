      ...
      <div className="signUp flex mt-18 p-4">
        <div className="cont max-w-[500px] m-auto bg-(--bg-secound) p-10 my-10">
          ...
          <form action="" className="flex flex-col ">
            ...
            <button className='h-[56px] w-[100%] cursor-pointer bg-(--color-main) text-xl text-(--hero-btntext) transition-all duration-300 hover:bg-(--hcolor-main) my-5'>Sign Up</button>
