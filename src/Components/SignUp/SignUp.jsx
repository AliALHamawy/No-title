        ...
        <div className="cont max-w-[500px] m-auto bg-(--bg-secound) p-10 my-10">
          ...
          <form action="" className="flex flex-col ">
            <div className="flex flex-col">
              ...
              <input className="p-2 bg-(--heroBtn-bg) text-(--textcolor-secound) outline-0 h-[45px] border border-(--heroBtn-bg) focus:border-(--color-main) mb-5 " type="text" name="" id="name" placeholder="Enter your Full Name" />
            </div>
            <div className="flex flex-col">
              <label className="text-[16px] text-(--textcolor-main) mb-2" htmlFor="email">Email</label>
              <input className="p-2 bg-(--heroBtn-bg) text-(--textcolor-secound) outline-0 h-[45px] border border-(--heroBtn-bg) focus:border-(--color-main) mb-5 " type="email" name="" id="email" placeholder="Enter your Email" />
            </div>
            <div className="flex flex-col">
            ...
            <button className='h-[56px] w-[100%] cursor-pointer bg-(--color-main) text-xl text-(--textcolor-main) transition-all duration-300 hover:bg-(--hcolor-main) my-5'>Sign Up</button>
            <p className="text-center text-(--textcolor-secound)">Already using Startup? <Link to="/SignIn" className="text-(--color-main)">Sign in</Link></p>
          </form>
        </div>
      </div>
    </>
