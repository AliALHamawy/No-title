        ...
        <div className="cont max-w-[500px] m-auto bg-(--bg-secound) p-10 my-10">
          ...
          <form action="" className="flex flex-col ">
            ...
            <div className="flex gap-2 items-center justify-between">
              ...
              <button className='h-[56px] w-[100%] cursor-pointer bg-(--color-main) text-xl text-(--textcolor-main) transition-all duration-300 hover:bg-(--hcolor-main) my-5'>Sign In</button>
